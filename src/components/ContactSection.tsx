  ...
  return (
    <>
      ...
      <section 
        ref={sectionRef}
        id="contact" 
        className={`py-32 transition-all duration-1000 relative overflow-hidden min-h-screen flex items-center ${
          sectionTheme === 'light' 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          ...
          <div className="text-center mb-20">
            <div className="relative inline-block">
              <h2 className={`text-6xl md:text-7xl font-bold mb-6 transition-all duration-1000 transform hover:scale-105 ${
                sectionTheme === 'light' 
              ...
              <div className={`absolute inset-0 text-6xl md:text-7xl font-bold -z-10 transform translate-x-2 translate-y-2 ${
            ...
            <p className={`text-2xl max-w-3xl mx-auto mb-12 transition-all duration-1000 transform hover:scale-105 ${
              sectionTheme === 'light' 
                ? 'text-gray-600' 
                : 'text-gray-300'
            }`}>
          ...
          <div className="mt-24 text-center">
            <div className={`inline-flex items-center space-x-4 px-8 py-4 rounded-full backdrop-blur-lg border transition-all duration-1000 ${
              sectionTheme === 'light'
                ? 'bg-white/20 border-gray-200/50 text-gray-700'
                : 'bg-black/20 border-gray-700/50 text-gray-300'
            }`}>
              <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
              <span className="font-medium">Available for exciting projects</span>
            </div>
          </div>
        </div>
      </section>
